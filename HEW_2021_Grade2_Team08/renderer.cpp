...
void SetWorldViewProjection2D( void )
{
	...
	D3DXMatrixOrthoOffCenterLH(&worldViewProjection, 0.0f, WINDOW_WIDTH, WINDOW_HEIGHT, 0.0f, 0.0f, 1.0f);
...
HRESULT InitRenderer(HINSTANCE hInstance, HWND hWnd/*, BOOL bWindow*/)
{
	...
	hr = D3DX11CompileFromFile( L"shader.hlsl", NULL, NULL, "VertexShaderPolygon", "vs_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, NULL, &pVSBlob, &pErrorBlob, NULL );
	if( FAILED(hr) )
	{
		MessageBox( NULL , (wchar_t*)pErrorBlob->GetBufferPointer(), L"VS", MB_OK | MB_ICONERROR );
	}
	...
	hr = D3DX11CompileFromFile( L"shader.hlsl", NULL, NULL, "PixelShaderPolygon", "ps_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, NULL, &pPSBlob, &pErrorBlob, NULL );
	if( FAILED(hr) )
	{
		MessageBox( NULL , (wchar_t*)pErrorBlob->GetBufferPointer(), L"PS", MB_OK | MB_ICONERROR );
	}
