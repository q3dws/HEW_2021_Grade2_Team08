...
{
	DrawSprite(tex_no, top_left_.x_, top_left_.y_, texture_size_.x_, texture_size_.y_, uv_.x_, uv_.y_, uv_size.x_, uv_size.y_);
}
...
{
	DrawSpriteLeftTop(tex_no, top_left_.x_, top_left_.y_, texture_size_.x_, texture_size_.y_, uv_.x_, uv_.y_, uv_size.x_, uv_size.y_);
}
...
void DrawSpriteRotCntr(int tex_no, Vec2 topleft, Vec2 size, Vec2 uv, Vec2 uv_wh, float rot, float alfa)
{
	DrawSpriteColorRotate(
		tex_no,
		topleft.x_, topleft.y_,
		size.x_, size.y_,
		uv.x_, uv.y_,
		uv_wh.x_, uv_wh.y_,
		D3DXCOLOR(1, 1, 1, alfa),
		rot
	);
}
